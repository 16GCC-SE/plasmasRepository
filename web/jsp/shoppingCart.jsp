...
<%@ page import="com.example.demo.dao.ShoppingCartDao" %>
<%@ page import="com.example.demo.dao.GoodsDao" %>
<%@ page import="com.example.demo.factory.DAOFactory" %>
<%@ page import="com.example.demo.bean.ShoppingCart" %>
<%@ page import="com.example.demo.bean.Goods" %>
